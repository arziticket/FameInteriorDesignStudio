...
jQuery(document).ready(function($) {
    ...
    function resetContentPos(i) {
        $($nectarSliders[i].container).find('.swiper-slide .content > *').css({
    ...
    function prevArrowAnimationDirectional(e) {
        ...
        $timeout = setTimeout(function() {
            ...
            $that.parents('.swiper-container').find('.swiper-wrapper').css({
    ...
    function nectarSliderMainInit() {
        ...
        if ($('body > #boxed').length === 0 &&
            ...
            $('.nectar-slider-wrap[data-full-width="true"], .parallax_slider_outer.first-section .nectar-slider-wrap')
                .css({
                    'left': -(($windowWidth - $smoothSrollWidth) / 2 - $('.main-content').width() / 2),
                    'margin-left': '0'
                });
        ...
        $('.nectar-slider-wrap').each(function(i) {
            ...
            if ($arrows == 'true' && $('#' + $(this).attr('id') + ' .swiper-wrapper > div').length > 1 &&
                ...
                $('body').on('click', '#' + $(this).attr('id') + ' .slider-prev', {
                    i: i
                }, prevArrowAnimation);
                ...
                $('body').on('click', '#' + $(this).attr('id') + ' .slider-next', {
                    i: i
                }, nextArrowAnimation);
            ...
            if (navigator.userAgent.match(/(Android|iPod|iPhone|iPad|IEMobile|Opera Mini)/)) {
                ...
                $that.find('.video-wrap').each(function() {
                    ...
                    $(this).find('video')[0].onplay = function() {
                        $videoSlide.find('video').css({
                            'opacity': '1'
                        });
                        setTimeout(function() {
                            $videoSlide.parents('.swiper-slide').find('.mobile-video-image').transition({
                                'opacity': '0'
                            }, 250);
        ...
        $('.nectar-slider-wrap').each(function(i) {
            ...
            if ($(this).css('visibility') != 'hidden') {
                ...
                if ($('body > #boxed').length === 0 &&
                    ...
                    $('.nectar-slider-wrap[data-full-width="true"], .parallax_slider_outer.first-section .nectar-slider-wrap').css({
                        'left': -(($windowWidth - $smoothSrollWidth) / 2 - $('.main-content').width() / 2),
                        'margin-left': '0'
                    });
                    ...
                    $('.nectar-slider-wrap[data-full-width="true"] .swiper-container, .nectar-slider-wrap[data-full-width="true"], .parallax_slider_outer.first-section .swiper-container, .parallax_slider_outer.first-section .nectar-slider-wrap').css({
    ...
    function captionTransition(obj) {
        ...
        if (!$('html').hasClass('no-video')) {
            if (captionTransString === 'fade_in_from_bottom') {
                ...
                $($containerClass + ' .swiper-slide .content p, ' + $containerClass + ' .swiper-slide .content h2, ' + $containerClass + ' .swiper-slide .content h1, ' + $containerClass + ' .swiper-slide .content h3, ' + $containerClass + ' .swiper-slide .content .buttons').stop(true, true).css({
                    'opacity': 0,
                ...
                $($containerClass + ' .swiper-slide .content .ns-heading-el .word').stop(true, true).css({
                    'opacity': '0'
                });
                $($containerClass + ' .swiper-slide .content .ns-heading-el .word > [class*="char"]').css({
                    'opacity': '0'
                });
                $($containerClass + ' .swiper-slide .content .ns-heading-el .word > [class*="char"] > span').css({
                    'transform': 'scale(0) translateZ(0)'
                });

                anime.remove($containerClass + ' .swiper-slide .content p, ' + $containerClass + ' .swiper-slide .content .buttons');
                $($containerClass + ' .swiper-slide .content p, ' + $containerClass + ' .swiper-slide .content .buttons').stop(true, true).css({
                    'opacity': 0,
                    'transform': 'translateZ(0) translateY(40px)'
                });
            }
